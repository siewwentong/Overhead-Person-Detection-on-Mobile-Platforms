...
parser.add_argument("--image_dir", help="image dir", default="images/")
...
# cap = cv2.VideoCapture('/home/elid/siewwen/test_video/testVideo_2.avi')
allfiles = glob.glob(args.image_dir + "/*.jpg")
allfiles.sort()
...
NUM_CLASSES = int(args.num_classes) #TO_BE_CONFIGURED
